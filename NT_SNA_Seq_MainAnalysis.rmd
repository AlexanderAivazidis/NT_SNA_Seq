...
doubletsScore_10xF = read.table('scrublet/FFT4G_10x_doublets_scores.txt')
doubletsScore_10xO = read.table('scrublet/OCT1_10x_doublets_scores.txt')
...
oddCluster = p15$data[p15$data$UMAP_1 < -5 & p15$data$UMAP_1 > -10 & p15$data$UMAP_2 > -8 & p15$data$UMAP_2 < -5 & p15$data$subtype == 'Glutamatergic_L5_PT',]
